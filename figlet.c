...
tpos_x=ch%16;
tpos_y=ch/16;
// ВНИМАНИЕ! Этот код написан в образовательных целях!
// В реальных проектах не используйте операции деления/остатка там, где их можно заменить на сдвиг или маски.

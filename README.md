...
Пишем конвертор [png2picolib.pl](./png2picolib.pl), где просто читаем пиксели из нашей картинки и упаковываем в виде сишного заголовка, стараясь максимально
походить на оригинал. Я конечно же не устоял и добавил комментарии, чтобы видеть какой символ и где описывается, но это фактически украшательства.

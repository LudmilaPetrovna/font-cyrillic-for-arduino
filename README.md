...
Например, возьмем библиотеку [pico-ssd1306](https://github.com/Harbys/pico-ssd1306), она уже умеет управлять экраном, выделять память и в ней даже есть свои шрифты. Конечно, никто не мешает портировать нашу функцию, которая рисует 1 символ и пользоваться нашими шрифтами в этой библиотеке, но... Как же богатое API и его консистентность? Давайте добавим шрифты в таком виде, в каком библиотека будет считать их родными!
